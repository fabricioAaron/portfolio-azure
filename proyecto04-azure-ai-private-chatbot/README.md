# Azure AI Policies Chatbot (RAG con PDFs internos)

Proyecto de asistente de IA que responde preguntas sobre las políticas internas de una empresa usando documentos PDF almacenados en Azure. El chatbot usa un modelo LLM en Azure AI Foundry y recuperación aumentada por búsqueda (RAG) con Azure AI Search y Azure Blob Storage.

## Objetivo del proyecto

- Permitir a empleados consultar “¿Cuál es la política sobre X?” y obtener respuestas basadas únicamente en los PDFs oficiales de la empresa.
...
- Opcional: Azure Key Vault / RBAC para protección de claves y permisos

## Pasos de implementación (resumen)

1. **Preparación de la suscripción**
   - Activar Azure for Students (o suscripción de pago).
   - Verificar acceso a Azure AI Foundry y Azure AI Search en una región soportada.
...
4. **Proyecto en Azure AI Foundry**
...
5. **Configuración del agente de chat**
